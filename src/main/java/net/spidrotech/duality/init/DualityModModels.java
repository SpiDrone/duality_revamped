...
import net.spidrotech.duality.client.model.*;
...
public class DualityModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(Modeldemonic_spider.LAYER_LOCATION, Modeldemonic_spider::createBodyLayer);
		event.registerLayerDefinition(Modelwebspit.LAYER_LOCATION, Modelwebspit::createBodyLayer);

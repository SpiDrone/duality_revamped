...
public class TestTextProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, String text) {
		...
		if ((text).equals("hell")) {
			...
			{
				DualityModVariables.PlayerVariables _vars = entity.getData(DualityModVariables.PLAYER_VARIABLES);
				_vars.EquippedAbilities = "lightning_hands_normal,lightning_hands_demonic,acid_spit,web_spit,firebolt,fireball_normal,fireball_greater,fireball_inferno,shimmer";
				_vars.markSyncDirty();
			}
		} else if (text.startsWith(",")) {
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					...
					public Component getDisplayName() {
						return Component.literal("CharacterSelector");
					}
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						return new CharacterSelectorMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
